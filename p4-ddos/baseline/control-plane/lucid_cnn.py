...
PREDICTION_HEADER = "Model,round_counter,round_time,TIME(sec),PACKETS,SAMPLES,DDOS%,ACC,ERR,F1,PPV,TP,FP,TN,FN,extr(sec),proc(sec),packets_captured_in_memory,total_packet_captured,Data_Source\n"
