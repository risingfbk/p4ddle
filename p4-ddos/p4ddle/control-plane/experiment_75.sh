...
export folder=../../dataset/TestSet-75/

declare -a attack_names=(dns mssql snmp ldap netbios portmap ssdp udplag)
declare -a attack_traces=(dns-chunk2-75.pcap mssql-chunk2-75.pcap snmp-chunk1-75.pcap ldap-chunk2-75.pcap netbios-chunk2-75.pcap portmap-chunk-full-75.pcap ssdp-chunk2-75.pcap udplag-chunk5-75.pcap)
declare -a benign_packets=(1961 18627 13031 6075 12066 12118 22723 15261)
...
do
	...
	do
		...
		sleep 1
		echo "register_reset flow_counter0" | simple_switch_CLI --thrift-port 22222
		sleep 1
		...
		sleep 1
		echo "register_reset flow_counter1" | simple_switch_CLI --thrift-port 22222
		sleep 1
